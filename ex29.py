#Faça um algoritmo que leia informações sobre um grupo de 5 pessoas, e calcule alguns dados estatísticos:
#Para cada pessoa do grupo deve ler nome, sexo (M/F), altura e peso. Calcular e escrever:
tm=0
tf=0
n=1
tpeso=0
...
print('Md peso Masculino:',mdpesom )
